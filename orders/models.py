...
from splitcloud.utils import unique_order_id_generator
...
class ProductPurchase(models.Model):
    ...
    order_id        = models.CharField(max_length=120) # foreign key not necessary here
    billing_profile = models.ForeignKey(BillingProfile, on_delete=models.PROTECT) # foreign key necessary for reverse lookup
    product         = models.ForeignKey(Product, on_delete=models.PROTECT) # reverse lookup can give count of products sold
